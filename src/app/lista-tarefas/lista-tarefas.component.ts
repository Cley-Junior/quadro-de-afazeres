...
import { checkButtonTrigger, filterTrigger, formButtonTrigger, highlightedStateTrigger, listStateTrigger, noTaskTrigger, shakeTrigger, shownStateTrigger } from '../animations';
...
@Component({
  ...
  animations: [highlightedStateTrigger, shownStateTrigger, checkButtonTrigger, filterTrigger, formButtonTrigger, shakeTrigger, listStateTrigger, noTaskTrigger]
})
export class ListaTarefasComponent implements OnInit {
  ...
  constructor(
    ...
    filtraTarefasPorDescricao(descricao: string)
    {
